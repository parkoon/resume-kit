...
const skills = [
  ...
  { id: 1, title: 'Enact.js', type: 'none', level: 1 },
  { id: 1, title: 'Electron.js', type: 'none', level: 1 },
  { id: 1, title: 'React Native', type: 'none', level: 1 },
  { id: 1, title: 'Firebase', type: 'none', level: 1 },
  { id: 1, title: 'Kotlin', type: 'none', level: 1 },
  { id: 1, title: 'Flutter', type: 'none', level: 1 },
  { id: 1, title: 'Storybook', type: 'none', level: 1 },
  { id: 1, title: 'MobX', type: 'none', level: 1 },
  { id: 1, title: 'Docker', type: 'none', level: 1 },
  { id: 1, title: 'MaterialUI', type: 'none', level: 1 },
  { id: 1, title: 'Redux', type: 'none', level: 1 },
  { id: 1, title: 'Antd', type: 'none', level: 1 },
  { id: 1, title: 'TypeORM', type: 'none', level: 1 },
  { id: 1, title: 'RESTful API', type: 'none', level: 1 },
  { id: 1, title: 'GraphQL', type: 'none', level: 1 },
  { id: 1, title: 'Vue.js', type: 'none', level: 1 },
  { id: 1, title: 'Angular.js', type: 'none', level: 1 },
  { id: 1, title: 'WebRTC', type: 'none', level: 1 },
  { id: 1, title: 'Styled-component', type: 'none', level: 1 },
  { id: 1, title: 'Sass', type: 'none', level: 1 },
  { id: 1, title: 'Webpack', type: 'none', level: 1 },
  { id: 1, title: 'Gulp', type: 'none', level: 1 },
  { id: 1, title: 'jQuery', type: 'none', level: 1 },
  ...
  { id: 5, title: 'Thymeleaf', type: 'none', level: 1 },
  { id: 5, title: 'JSP', type: 'none', level: 1 },
  { id: 6, title: 'Apache', type: 'none', level: 1 },
  { id: 7, title: 'PHP', type: 'none', level: 1 },
  { id: 8, title: 'Java', type: 'none', level: 1 },
  { id: 8, title: 'EJS', type: 'none', level: 1 },
  { id: 8, title: 'Mustache', type: 'none', level: 1 },
  { id: 8, title: 'PM2', type: 'none', level: 1 },
  { id: 8, title: 'Pug', type: 'none', level: 1 },
  { id: 8, title: 'Oracle', type: 'none', level: 1 },
  { id: 8, title: 'JPA', type: 'none', level: 1 },
  { id: 9, title: 'Spring', type: 'none', level: 1 },
  { id: 9, title: 'Spring Boot', type: 'none', level: 1 },
  ...
  { id: 27, title: 'Slack', type: 'none', level: 1 },
  { id: 27, title: 'Notion', type: 'none', level: 1 },
